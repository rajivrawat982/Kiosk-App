...
import { CLEAR_SEATS } from '../../reduxConfig/actionTypes';
...
class seats extends Component {
  ...
  componentDidMount() {
    axios.get("http://10.10.3.94:4000/api/allseats").then(
      response => {
        this.setState({
          list: response.data
        })
  ...
  //         axios.post("http://10.10.3.94:4000/api/clearSeats" , {seats: this.props.userSelectedSeats}).then(
